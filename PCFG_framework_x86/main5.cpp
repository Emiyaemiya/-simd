...
/*
g++ main5.cpp train.cpp guessing.cpp md5.cpp -o main5 -mavx2
g++ main5.cpp train.cpp guessing.cpp md5.cpp -o O1main5 -O1 -mavx2
g++ main5.cpp train.cpp guessing.cpp md5.cpp -o O2main5 -O2 -mavx2
*/
/*
Guess time: 2.48761 seconds
Hash time: 5.62592 seconds
Train time: 33.0091 seconds
O1
Guess time: 0.211165 seconds
Hash time: 0.59923 seconds
Train time: 13.0912 seconds
O2
Guess time: 0.238946 seconds
Hash time: 0.625135 seconds
Train time: 9.47318 seconds
*/
int main() {
    double time_hash = 0;  
    double time_guess = 0; 
        ...
        if (curr_num > 1000000) {
            ...
            while (processed < q.guesses.size()) {
                ...
                if (batch_buffer.size() == SIMD_BATCH_SIZE) {
                    ...
                    MD5Hash_AVX2_4way(batch_inputs, batch_states);
