...
void MD5Hash_NEON(string inputs[], bit32 states[][4], int num_inputs) {
    const int parallel_factor = 4; // 同时处理4个消息
	...
	int lengths[4];
	int valid_count = parallel_factor;
